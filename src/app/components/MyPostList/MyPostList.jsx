    ...
    const fetchPosts = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `${config.API_URL}/api/v1/users/${userData.id}/posts`,
          {
            headers: {
  ...
  return (
    <div className="p-10">
      <div className="flex justify-between items-center ">
        ...
        {userData?.id && postsData.length > 0 ? (
      ...
      <div className="grid grid-cols-1 gap-3 mb-7 overflow-y-auto scrollbar_none pb-20 max-h-[70vh]">
        {loading && (
          <>
            {[...Array(8)].map((_, i) => (
              <div
        ...
        {!loading && paginatedPosts.length === 0 && (
          <p className="text-center pt-5">No posts found</p>
        )}
